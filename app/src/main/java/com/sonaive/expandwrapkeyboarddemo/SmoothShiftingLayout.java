 ...
 */
public class SmoothShiftingLayout extends LinearLayout {
    ...
    private int mStatus;
    private int mAnimTime = 350;

    public SmoothShiftingLayout(Context context) {
        super(context);
    }

    public SmoothShiftingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
